...
model = dict(
    ...
    pretrained=
    '/mnt/data/nick/segm/ViT-Adapter/segmentation/beitv2_large_patch16_224_pt1k_ft21k.pth',
    backbone=dict(
        type='BEiTAdapter',
        patch_size=16,
        embed_dim=1024,
...
data = dict(
    ...
    train=dict(
        type='SUADDDataset',
        data_root=
        '/mnt/data/nick/segm/suadd23-semseg-amazon/mmsegmentation/data/suadd23/',
